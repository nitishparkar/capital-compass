export const QNA_GENERATOR_TEMPLATE: string = `
Read the startup information provided below, which is extracted from its pitch deck and is delimited by '---', and answer the questions that follow.
